...
Every SDK function mapped to its parameters, trigger conditions, and integration points.

> *For the conceptual overview of what HiveLoop captures (Identity / State / Activity), see the [Observability Model](observability-model.html).*

---

## Quick Reference — All 28 Sensors
...
> *See the [Quick Reference](#quick-reference--all-28-sensors) table at the top of this page for a complete at-a-glance summary of all 28 sensors.*
