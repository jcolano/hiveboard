...
# ═══════════════════════════════════════════════════════════════════════════
#  INSIGHTS ENGINE ENDPOINTS (Pre-Aggregated Analytics)
# ═══════════════════════════════════════════════════════════════════════════
...
@app.get("/v1/insights/timeseries")
...
# --- Admin: Rebuild aggregates ---

@app.post("/v1/admin/rebuild-aggregates")
